...
namespace XNATerrainPipeline
{
    ...
    public class TerrainProcessor : ContentProcessor<Texture2DContent, HeightMapInfoContent>
    {
        ...
        /// </summary>
        public override HeightMapInfoContent Process(Texture2DContent input,
                                             ContentProcessorContext context)
        {
            ...
            // model's tag.
            return new HeightMapInfoContent(model, terrainMesh, scale, heightfield.Width, heightfield.Height);
        }
