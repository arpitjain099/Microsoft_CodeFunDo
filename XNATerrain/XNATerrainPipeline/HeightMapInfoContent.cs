...
namespace XNATerrainPipeline
{
    ...
    public class HeightMapInfoContent
    {
        ...
        public VertexContent Vertex { get; set; }
        ...
        /// array.
        /// </summary>
        public HeightMapInfoContent(ModelContent model, MeshContent terrainMesh, float terrainScale,
    ...
    public class HeightMapInfoWriter : ContentTypeWriter<HeightMapInfoContent>
    {
        ...
        {
            return "XNATerrainHeightmap.XNATerrain, " +
                "XNATerrainHeightmap, Version=1.0.0.0, Culture=neutral";
        }
        ...
        {
            return "XNATerrainHeightmap.HeightMapInfoReader, " +
                "XNATerrainHeightmap, Version=1.0.0.0, Culture=neutral";
        }
    }
}
